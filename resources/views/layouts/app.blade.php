                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->isAdmin())
                            ...
                            {{-- Ventas (Validación de existencia de ruta) --}}
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('admin.sales.*') ? 'active' : '' }}"
                                    href="{{ Route::has('admin.sales.index') ? route('admin.sales.index') : '#' }}"
                                    @if(!Route::has('admin.sales.index')) title="Módulo pendiente de desarrollo" @endif>
                                    Ventas
                                </a>
                            </li>
                            ...
                            {{-- Contabilidad --}}
                            <li class="nav-item">
                                <a class="nav-link" href="#" title="Módulo pendiente de desarrollo">
                                    Contabilidad
                                </a>
                            </li>
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <form method="POST" action="{{ route('logout') }}" class="d-inline">
                                @csrf
                                <button type="submit" class="nav-link btn btn-link text-decoration-none border-0 py-0">
                                    Cerrar sesión
                                </button>
                            </form>
                        </li>
